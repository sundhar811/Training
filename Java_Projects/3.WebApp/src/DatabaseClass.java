...
public class DatabaseClass {
    ...
    static ResultSet fetchUserCredentials(int userId) throws SQLException{
    ...
    static ResultSet fetchUserInfo(int userId) throws SQLException{
    ...
    static boolean checkUserLoginNameRedundancy(String un) throws SQLException, ClassNotFoundException{
...
//            System.out.println("Username already exists.");
    ...
    static boolean checkUserEmailRedundancy(String umail) throws SQLException, ClassNotFoundException{
...
//            System.out.println("e-mail already exists.");
    ...
    static int insertUserCredentialsIntoDb(UserPlan user) throws SQLException{
        int rows_affected;
...
//        System.out.println("USER CREDENTIAL INSERTION IS SUCCESSFUL");
    ...
    static int insertUserInfoIntoDb(UserPlan user) throws SQLException{
        int rows_affected;
...
//        System.out.println("USER INFORMATION INSERTION IS SUCCESSFUL");
    ...
    static int checkSellerCredentials(SellerBuilderPlan login_seller) throws ClassNotFoundException, SQLException {
        int id = -1;
    ...
    static ResultSet fetchSellerCredentials(int sellerId) throws SQLException{
    ...
    static ResultSet fetchSellerInfo(int sellerId) throws SQLException{
    ...
    static boolean checkSellerLoginNameRedundancy(String un) throws SQLException, ClassNotFoundException{
...
//            System.out.println("Username already exists.");
    ...
    static boolean checkSellerEmailRedundancy(String smail) throws SQLException, ClassNotFoundException{
...
//            System.out.println("e-mail already exists.");
    ...
    static int insertSellerCredentialsIntoDb(SellerPlan seller) throws SQLException{
        int rows_affected;
...
//        System.out.println("SELLER CREDENTIAL INSERTION IS SUCCESSFUL");
    ...
    static int insertSellerInfoIntoDb(SellerPlan seller) throws SQLException{
        int rows_affected;
...
//        System.out.println("SELLER INFORMATION INSERTION IS SUCCESSFUL");
    ...
    static ResultSet displayAllProductsById() throws SQLException {
    ...
    static ResultSet displayAllProductsByName() throws SQLException {
        String query = "SELECT p.pid, p.pname, p.stock, p.price, p.avg_rating, s.sname " +
    ...
    static ResultSet displayAllProductsByPrice() throws SQLException{
        String query = "SELECT p.pid, p.pname, p.stock, p.price, p.avg_rating, s.sname " +
    ...
    static ResultSet displayUserAddress(int user_id) throws SQLException{
    ...
    static int insertUserDetails(UserDetailsPlan user_details) throws SQLException{
        int rows_affected;
...
//        System.out.println("USER DETAILS INSERTION IS SUCCESSFUL");
    ...
    static ResultSet displaySellerAddress(int seller_id) throws SQLException{
    ...
    static int insertSellerDetails(SellerDetailsPlan seller_details) throws SQLException{
        int rows_affected;
...
//        System.out.println("USER DETAILS INSERTION IS SUCCESSFUL");
    ...
    static ResultSet displayCurrentSellerProduct(int seller_id) throws SQLException{
    ...
    static ResultSet displayOldSellerProduct(int seller_id) throws SQLException{
    ...
    static int addNewProducts(ProductPlan product, int seller_id) throws SQLException{
        int rows_affected;
...
//        System.out.println("PRODUCT DETAILS INSERTION IS SUCCESSFUL");
    ...
    static int deleteProducts(int seller_id, int pid) throws SQLException{
        int rows_affected;
...
//        System.out.println("PRODUCT DETAILS DELETION IS SUCCESSFUL");
    ...
    static String getProductName(int pid) throws SQLException{
    ...
    static int updateProductName(int pid, String pname) throws SQLException{
        int rows_affected;
    ...
    static int getProductStock(int pid) throws SQLException{
        PreparedStatement ps;
        String query;
        int stock;
    ...
    static int updateProductStock(int pid, int stock) throws SQLException{
        int rows_affected;
    ...
    static float getProductPrice(int pid) throws SQLException{
        PreparedStatement ps;
        String query;
        float price;
    ...
    static int updateProductPriceInProductList(int pid, float price) throws SQLException{
        int rows_affected;
    ...
    static int updateProductPriceInUserCart(int pid, float price) throws SQLException{
        int rows_affected;
    ...
    static ResultSet fetchItemsInUserCart(int userid) throws SQLException{
    ...
    static boolean checkProductForCart(int product_id, int stock) throws SQLException, ClassNotFoundException{
//        if (stock <= 0) {
...
//        }
    ...
    static float computePriceForProductInCart(int pid, int stock) throws SQLException, ClassNotFoundException{
        float cprice;
    ...
    static int addProductsToCart(CartPlan cart) throws SQLException{
        int rows_affected;
    ...
    static int getCurrentQuantityFromCart(CartPlan cart) throws SQLException, ClassNotFoundException{
    ...
    static int modifyProductInCart(CartPlan cart) throws SQLException{
        int rows_affected;
    ...
    static int removeProductFromCart(int user_id, int pr_id) throws SQLException{
        int rows_affected;
    ...
    static ResultSet checkAvailabilityInFinalCart(int userid) throws SQLException{
    ...
    static int modifyProductInFinalCart(CartPlan cart, ProductPlan product) throws SQLException{
        int rows_affected;
    ...
    static int deleteProductInFinalCart(CartPlan cart) throws SQLException{
        int rows_affected;
        String query = "DELETE FROM current_cart WHERE uid = ? AND pid = ?";
    ...
    static int insertIntoBill(BillPlan bill) throws SQLException{
        int rows_affected;
    ...
    static int getLastGeneratedBillId(UserPlan user) throws SQLException{
    ...
    static int insertIntoOrderHistory(OrderHistoryPlan order) throws SQLException{
        int rows_affected;
    ...
    static ResultSet fetchTimeStampOfCurrentBill(BillPlan bill) throws SQLException{
    ...
    static ResultSet fetchOrderHistory(UserPlan user) throws SQLException{
    ...
    static ResultSet fetchWishList(UserPlan user) throws SQLException{
    ...
    static boolean checkProductDuplicate(WishListPlan wishlist, boolean flag) throws SQLException, ClassNotFoundException{
    ...
    static int addProductToWishList(WishListPlan wishlist) throws SQLException{
        int rows_affected;
    ...
    static int deleteProductFromWishList(WishListPlan wishlist) throws SQLException{
        int rows_affected;
